...
import com.kaya.risk31app.Adapters.RiskAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = fragmentView.findViewById(R.id.risk_recycler_view);
...
//        }
    ...
    public void onStart() {
        ...
        call = service.getRisks();


        call.enqueue(new Callback<RiskResponse>() {
            @Override
            public void onResponse(Call<RiskResponse> call, Response<RiskResponse> response) {
                if (response.isSuccessful()) {
                    riskAdapter = new RiskAdapter(getContext(), response.body().getData());
